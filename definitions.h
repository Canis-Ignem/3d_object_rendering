...
typedef struct {
    ...
    vector3 normal;                     // vector normal de la cara
} face;
...
typedef struct camara{
    ...
    double params[4];
    struct camara *next;
    // Guardar la inversa que es las X,Y,Z por columnas
...
//Material para la interaccion con las luces
